...
class CouponPersistenceAdapter implements LoadCouponPort, CreateCouponPort, UpdateCouponStatePort, DeleteCouponPort, FindCouponPort {
    ...
    @Override
    public Coupon loadCoupon(Long ticketId) {
        CouponJpaEntity couponJpaEntity = couponRepository.findById(ticketId)
    ...
    @Override
    public void decreaseRemainQuantity(Long ticketId) {
        couponRepository.decreaseRemainQuantityById(ticketId);
    }
